...
if st.button("Analyze with Grok", type="primary"):
    if not question or not question.strip():
        ...
        st.markdown("<br><hr><p style='text-align:center;color:#888;font-size:18px'>Made in INDIA with ❤️ by Raghavendra  Siddappa | Day 3 of GrenAI Era</p>", unsafe_allow_html=True)
